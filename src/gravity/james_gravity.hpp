#ifndef GRAVITY_JAMESGRAVITY_HPP_
#define GRAVITY_JAMESGRAVITY_HPP_
...
//========================================================================================
//! \file james_gravity.hpp
//  \brief header file for JamesGravityCar and JamesGravityCyl
...
class JamesGravityCar;
class JamesGravityCyl;
...
//! \class JamesGravityDriver
//  \brief James gravity driver

class JamesGravityDriver {
 public:
  JamesGravityDriver(Mesh *pm, ParameterInput *pin);
  ~JamesGravityDriver();

  JamesGravityCar *pmy_og_car;
  JamesGravityCyl *pmy_og_cyl;
...
class JamesGravityCar : public Gravity {
 public:
  JamesGravityCar(JamesGravityDriver *pcd, MeshBlock *pmb, ParameterInput *pin);
  ~JamesGravityCar();
 ...
 protected:
  ...
  JamesGravityDriver *pmy_driver_;
...
class JamesGravityCyl : public Gravity {
 public:
  JamesGravityCyl(JamesGravityDriver *pcd, MeshBlock *pmb, ParameterInput *pin);
  ~JamesGravityCyl();
...
#endif // GRAVITY_JAMESGRAVITY_HPP_
